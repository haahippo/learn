...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = FC.Conv2d(1, 10, kernel_size=5)
        self.conv2 = FC.Conv2d(10, 20, kernel_size=5)

        self.fc1 = FC.Linear(320, 50)
        self.fc2 = FC.Linear(50, 10)
...
def train(epoch):
    for batch_idx, (data, target) in enumerate(train_loader):
        optimizer.zero_grad()
        output = network(data)
        loss = FC.CrossEntropyLoss()(output, target)
        loss.backward()
        optimizer.step()
